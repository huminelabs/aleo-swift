...
// File automatically generated by swift-bridge.
#include <stdint.h>
typedef struct RTransactionWrapper RTransactionWrapper;
void __swift_bridge__$RTransactionWrapper$_free(void* self);

void* __swift_bridge__$Vec_RTransactionWrapper$new(void);
void __swift_bridge__$Vec_RTransactionWrapper$drop(void* vec_ptr);
void __swift_bridge__$Vec_RTransactionWrapper$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_RTransactionWrapper$pop(void* vec_ptr);
void* __swift_bridge__$Vec_RTransactionWrapper$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_RTransactionWrapper$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_RTransactionWrapper$len(void* vec_ptr);
void* __swift_bridge__$Vec_RTransactionWrapper$as_ptr(void* vec_ptr);

typedef struct RKVPair RKVPair;
void __swift_bridge__$RKVPair$_free(void* self);

void* __swift_bridge__$Vec_RKVPair$new(void);
void __swift_bridge__$Vec_RKVPair$drop(void* vec_ptr);
void __swift_bridge__$Vec_RKVPair$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_RKVPair$pop(void* vec_ptr);
void* __swift_bridge__$Vec_RKVPair$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_RKVPair$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_RKVPair$len(void* vec_ptr);
void* __swift_bridge__$Vec_RKVPair$as_ptr(void* vec_ptr);

typedef struct RHashMapStrings RHashMapStrings;
void __swift_bridge__$RHashMapStrings$_free(void* self);

void* __swift_bridge__$Vec_RHashMapStrings$new(void);
void __swift_bridge__$Vec_RHashMapStrings$drop(void* vec_ptr);
void __swift_bridge__$Vec_RHashMapStrings$push(void* vec_ptr, void* item_ptr);
void* __swift_bridge__$Vec_RHashMapStrings$pop(void* vec_ptr);
void* __swift_bridge__$Vec_RHashMapStrings$get(void* vec_ptr, uintptr_t index);
void* __swift_bridge__$Vec_RHashMapStrings$get_mut(void* vec_ptr, uintptr_t index);
uintptr_t __swift_bridge__$Vec_RHashMapStrings$len(void* vec_ptr);
void* __swift_bridge__$Vec_RHashMapStrings$as_ptr(void* vec_ptr);
...
void* __swift_bridge__$RHashMapStrings$new(void* vector);
