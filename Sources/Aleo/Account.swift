...
public struct Account {
    ...
    func encryptAccount(with password: String) -> PrivateKeyCiphertext? {
    ...
    func decryptRecord(ciphertext: String) -> String? {
    ...
    func decryptRecords(ciphertexts: [String]) -> [String?] {
    ...
    func isOwner(of ciphertext: RecordCiphertext) -> Bool {
    ...
    ///
    /// - Parameter viewKey: View key used to decrypt the ciphertext.
    func isOwner(of ciphertext: String) -> Bool {
    ...
    func sign(message: [UInt8]) -> Signature {
    ...
    func verify(message: [UInt8], signature: Signature) -> Bool {
