...
pub use snarkvm_console::{
    ...
    program::{
        Ciphertext, Entry, EntryType, Identifier, Literal, Plaintext, PlaintextType, ProgramID,
        ProgramOwner, Record, Response, ValueType,
    },
    types::Field,
};
...
pub use snarkvm_synthesizer::{
    cost_in_microcredits, deployment_cost,
